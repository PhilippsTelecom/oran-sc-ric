...
class MyXapp(xAppBase):
    ...
    def start(self, e2_node_id, ue_id):
        while self.running:
            ...
            # Try to send a RC - Radio Control
            drb_id = 1
            mark_prob = 0
            print("{} Send RIC Control Request to E2 node ID: {} for UE ID: {}, DRB ID: {}, Marking Probability: {}".format(current_time.strftime("%H:%M:%S"), e2_node_id, ue_id, drb_id, mark_prob))
            self.e2sm_rc.control_drb_qos(e2_node_id, ue_id,drb_id,mark_prob,ack_request=1)
            time.sleep(1)
...
if __name__ == '__main__':
    ...
    e2_node_id = "gnb_001_001_00019b" # CU-CP / ID gnbc_001_001_00019b_0 / gnb_001_001_00019b / gnbd_001_001_00019b_0
